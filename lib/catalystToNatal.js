...
function classifyResponse(eventItem, hits, totalScore) {
  ...
  return `${label} touches the natal chart through ${mainContact}. Expected response: transitional behaviour; watch whether it resolves into expansion or pressure.`;
}
