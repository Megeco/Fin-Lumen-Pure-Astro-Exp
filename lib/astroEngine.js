...
} from "./replayValidationIntelligence.js";

import {
  buildNarrativeSynthesis
} from "./narrativeSynthesisEngine.js";

import {
  buildDecisionPipelineV35
} from "./v35/decisionPipeline.js";

import { scoreCycleRunwayV35 } from "./v35/astroTruth.js";
...
function scoreCycleAsymmetry(resonance, windows, catalystScan, natalProfile) {
  return scoreCycleRunwayV35(resonance, windows);
}
...
export async function astroEngine(stock) {
  ...
  const company = await resolveCompany(ticker, stock, { asOfDate: date });
  ...
  const researchReading = replayValidationIntelligence?.currentResearchReading || {};
  ...
  return {
    ...
    cycle_potential_confidence: decisionV35.behaviour.confidence,
    cycle_potential_next_gate: decisionV35.timingPath.nextGate,
    cycle_potential_next_tactical_gate: decisionV35.timingPath.tacticalGate,
    cycle_potential_next_strategic_gate: decisionV35.timingPath.strategicGate,
    ...
    replay_validation_intelligence: replayValidationIntelligence,
    narrative_synthesis: narrativeSynthesis,
    decision_v35: decisionV35,
    production_decision_version: decisionV35.version,
    production_source: "v35.0-holistic-astro-to-capital",
    production_current_state: decisionV35.language.headline,
    production_single_story: decisionV35.language.singleStory,
    production_tactical_action: decisionV35.language.capital.existingPosition,
    production_fresh_tactical_action: decisionV35.language.capital.freshTacticalCapital,
    production_strategic_action: decisionV35.language.capital.strategicCapital,
    production_passive_verdict: decisionV35.language.capital.passiveLongTermCapital,
    production_timing_path: decisionV35.language.timingPath,
    production_tactical_timing_path: decisionV35.language.tacticalTimingPath,
    production_strategic_timing_path: decisionV35.language.strategicTimingPath,
    production_protection_date: decisionV35.timingPath?.tacticalGate?.role === "PRESSURE_CHECK" ? decisionV35.timingPath.tacticalGate.date : decisionV35.timingPath?.strategicGate?.role === "STRATEGIC_PROTECTION_REVIEW" ? decisionV35.timingPath.strategicGate.date : null,
    production_acceleration_date: ["REENTRY_REVIEW", "STRATEGIC_BUILD_REVIEW", "FULL_BUILD_UPGRADE_REVIEW"].includes(decisionV35.timingPath?.strategicGate?.role) ? decisionV35.timingPath.strategicGate.date : null,
    production_dormancy_type: researchReading?.dormancy?.type || null,
    production_dormancy_reason: researchReading?.dormancy?.reason || null,
    production_contradiction_flags: replayValidationIntelligence?.disagreements || [],
    current_transits: {
      jupiter: {
